...
http.createServer(function (req, res) {
	...
	if (E_from.length > 0 && E_from != 'undefined') {
		...
		transporter.sendMail(mailOptions, function (error, info) {
			if (error) {			
				...
				//Returns XML that is compatible with REST Connector
				res.end('<?xml version="1.0" encoding="UTF-8"?><root><row><Result>' + error + '</Result></row></root>');
			...
			//Returns XML that is compatible with REST Connector
			res.end('<?xml version="1.0" encoding="UTF-8"?><root><row><Result>Success</Result></row></root>');
		}
	...
	{
			//Returns XML that is compatible with REST Connector
			res.end('<?xml version="1.0" encoding="UTF-8"?><root><row><Result>Missing Required Parameters</Result></row></root>');
			return;
	};
